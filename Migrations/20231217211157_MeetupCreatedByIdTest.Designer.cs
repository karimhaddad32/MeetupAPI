...
namespace MeetupAPI.Migrations
{
    ...
    [Migration("20231217211157_MeetupCreatedByIdTest")]
    partial class MeetupCreatedByIdTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MeetupAPI.Entities.Meetup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedById = 1,
                            Date = new DateTime(2023, 12, 24, 16, 11, 56, 185, DateTimeKind.Local).AddTicks(8630),
                            IsPrivate = false,
                            Name = "Tech Meetup",
                            Organizer = "John Doe"
                        },
                        new
                        {
                            Id = 2,
                            CreatedById = 2,
                            Date = new DateTime(2023, 12, 31, 16, 11, 56, 186, DateTimeKind.Local).AddTicks(603),
                            IsPrivate = true,
